...
public class TestCard
{
    ...
    public delegate void ReceivedYUVFrameHandler(uint timestamp, int width, int height, ReadOnlySpan<byte> data);
    public delegate void ReceivedAudioFrameHandler(uint timestamp, ReadOnlySpan<short> data);
